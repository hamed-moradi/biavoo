...
namespace shared.utility._app
{
    public class AppSettings
    {
        ...
        public static string MaxDistance => _configuration["Custom:MaxDistance"];
        public static string MaxSpeed => _configuration["Custom:MaxSpeed"];
        public static string MaxAccurancy => _configuration["Custom:MaxAccurancy"];
    }
}